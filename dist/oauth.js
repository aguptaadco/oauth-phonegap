...
module.exports = function(Materia) {
  ...
  oauth = {
    ...
    popup: function(provider, opts, callback) {
      ...
      wnd = window.open(url, "_blank", 'allowinlinemediaplayback=yes,toolbar=yes,closebuttoncaption=Back,presentationstyle=formsheet,toolbarposition=top,clearsessioncache=no,clearcache=yes');
